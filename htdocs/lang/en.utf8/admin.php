...
$string['potentialtutors'] = 'Potential tutors';
$string['currenttutors'] = 'Current tutors';
$string['archivegroup'] = 'Archive current group';
$string['archivegroupprefix'] = 'Archive prefix';
...
$string['removefromgroups'] = 'Remove From Groups';
...
$string['confirmremovefromgroups'] = 'Are you sure you want to remove these users from all groups?';
