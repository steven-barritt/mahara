...
// my groups
$string['groupname'] = 'Course name';
$string['creategroup'] = 'Create course';
...
$string['addedtogroupsubject'] = 'You were added to a course';
...
$string['canteditdontown'] = 'You cannot edit this course because you do not own it.';
$string['groupdescription'] = 'Course description';
$string['groupurl'] = 'Course homepage URL';
$string['groupurldescription'] = "The URL of your course's homepage. This field must be 3-30 characters long.";
$string['groupurltaken'] = 'That URL is already taken by another course.';
