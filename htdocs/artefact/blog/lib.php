...
class ArtefactTypeBlog extends ArtefactType {
    ...
    public static function new_blog(User $user, array $values) {
        ...
        $artefact->commit();
		/*SB attach a folder to the new blog still todo
		$data = (object) array(
...
//		var_dump($post);
    ...
    public static function get_posts($id, $limit, $offset, $viewoptions=null, $order='DESC', $shortpost=false) {
        ...
        $data = get_records_sql_assoc('
            ...
            ORDER BY bp.published '.$order.', a.ctime '.$order.', a.id '.$order,
            array($id),
            $offset, $limit
        );
    ...
    public static function get_links($id) {
        ...
        return array(
            //SB I might have changed this to this = '_default' => $wwwroot . 'artefact/blog/post.php?blogpost=' . $id,
