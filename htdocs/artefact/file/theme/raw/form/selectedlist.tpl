 ...
 <tbody>
  ...
  <tr class="{cycle values='r0,r1'}{if $highlight && $highlight == $file->id} highlight-file{/if}">
    <td class="icon-container">
      <img src="{if $file->artefacttype == 'image' || $file->artefacttype == 'profileicon'}{$WWWROOT}artefact/file/download.php?file={$file->id}&size=200x200{else}{theme_url filename=images/`$file->artefacttype`.png}{/if}">
    </td>
    <td class="filename">
