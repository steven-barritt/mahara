...
<div id="edituser">
    ...
    <div class="fullwidth" id="useraccountsettings">
        ...
        <div id="useraccountsettingsleft">
            <div id="profilepict">
                <a href="{profile_url($user)}"><img src="{profile_icon_url user=$user maxheight=100 maxwidth=100}" style="max-width:100px;max-height:100px;" alt="{str tag=profileimagetext arg1=$user|display_default_name}"></a>
