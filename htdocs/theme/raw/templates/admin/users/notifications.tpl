...
{foreach from=$users item='user' key='userid'}
                <tr class="{cycle values="r0,r1"}">
                    <td class='center'><img src="{profile_icon_url user=$user.user maxheight=40 maxwidth=40}" style="max-width:40px;max-height:40px;" alt="{str tag=profileimagetext arg1=$user.user|display_default_name}"/></td>
