      ...
      <td class="lastcomment">
        {if $view.commenttext}
          ...
          {if $view.commentauthor}
            <span class="poster"><a href="{profile_url($view.commentauthor)}"><img src="{profile_icon_url user=$view.commentauthor maxwidth=20 maxheight=20}"  style="max-width:20px;max-height:20px;" alt="{str tag=profileimagetext arg1=$view.commentauthor|display_default_name}" class="profile-icon-container"> {$view.commentauthor|display_name}</a> - </span>
          {else}
