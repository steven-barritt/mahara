    ...
    {foreach from=$messages item=message}
        <div class="{cycle values='r0,r1'} listrow">
          <div class="fl membericon">
            <img src="{profile_icon_url user=$message->from maxwidth=40 maxheight=40}"  style="max-width:40px;max-height:40px;" alt="{str tag=profileimagetext arg1=$user|display_default_name}">
          </div>
