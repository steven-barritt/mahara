{if $results.data}
        {foreach from=$results.cdata item=row}
            ...
            <div class="{cycle values='r0,r1'} listrow">
              <div class="fl membericon"><img src="{profile_icon_url user=$r maxwidth=40 maxheight=40}"  style="max-width:40px;max-height:40px;" alt="{str tag=profileimagetext arg1=$r|display_default_name}"></div>
