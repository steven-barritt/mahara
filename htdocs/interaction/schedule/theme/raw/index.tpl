...
{else}
<a href="{$WWWROOT}interaction/schedule/editevent.php?id=0&schedule={$schedule->id}&view={$view}&month={$month}&year={$year}&returnto={$groupid}" class="btn newschedule">{str tag="newevent" section=interaction.schedule}</a>
