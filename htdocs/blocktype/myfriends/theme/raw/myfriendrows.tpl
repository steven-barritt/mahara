        ...
        {foreach from=$row item=friend}
            <div class="{cycle values='d0,d1'} center friendcell">
                <a href="{profile_url($friend)}">
                   <img src="{profile_icon_url user=$friend maxwidth=60 maxheight=60}"  style="max-width:60px;max-height:60px;" alt="{str tag=profileimagetext arg1=$friend|display_default_name}">
                </a>
