    ...
    {else}
        <table class="fullwidth"><tr class="{cycle values='r0,r1'}">
                <td align="center">{str tag=noeventsyet section=interaction.schedule args=$limittext}</td>
            </tr>
        </table>
    {/if}
    <div class="morelinkwrap"><a class="morelink" href="{$WWWROOT}interaction/schedule/schedule.php">{str tag=gotoschedule section=interaction.schedule} &raquo;</a></div>
